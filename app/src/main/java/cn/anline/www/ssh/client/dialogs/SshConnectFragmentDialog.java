package cn.anline.www.ssh.client.dialogs;
...
import cn.anline.www.ssh.client.sshutils.SessionUserInfo;
...
public class SshConnectFragmentDialog  extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ssh_client_form_editconfig, container, false);
