...
import cn.anline.www.ftp.server.primftpd.log.PrimFtpdLoggerBinder;
import cn.anline.www.ftp.server.primftpd.prefs.AboutActivity;
import cn.anline.www.ftp.server.primftpd.prefs.FtpPrefsActivityThemeDark;
import cn.anline.www.ftp.server.primftpd.prefs.FtpPrefsActivityThemeLight;
import cn.anline.www.ftp.server.primftpd.prefs.LoadPrefsUtil;
import cn.anline.www.ftp.server.primftpd.prefs.Logging;
import cn.anline.www.ftp.server.primftpd.prefs.Theme;
import cn.anline.www.ftp.server.primftpd.util.KeyGenerator;
import cn.anline.www.ftp.server.primftpd.util.KeyInfoProvider;
import cn.anline.www.ftp.server.primftpd.util.NotificationUtil;
import cn.anline.www.ftp.server.primftpd.util.PrngFixes;
...
public class PrimitiveFtpdActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.prim_ftp_layout);
